...
return new class extends Migration {
    ...
    {
        Schema::create('user_package_subscription_logs', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('status', ['0', '1', '2'])->comment('1=> active 0 => upcoming 2 => expired');
            $table->timestamps();
            $table->softDeletes();
    ...
    {
        Schema::dropIfExists('user_package_subscription_logs');
    }
};
