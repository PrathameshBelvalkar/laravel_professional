...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::table('user_package_subscriptions', function (Blueprint $table) {
            ...
            $table->foreign('last_subscriptions_log_id')->references('id')->on('user_package_subscription_logs');
            $table->foreign('current_subscriptions_log_id')->references('id')->on('user_package_subscription_logs');
        });
    }
