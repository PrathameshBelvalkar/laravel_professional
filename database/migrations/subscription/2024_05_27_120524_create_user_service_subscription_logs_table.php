...
return new class extends Migration {
    ...
    {
        Schema::create('user_service_subscription_logs', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('status', ['0', '1', '2'])->comment('1 active 2 expired 0 upcoming');
            $table->timestamps();
            $table->softDeletes();
    ...
    {
        Schema::dropIfExists('user_service_subscription_logs');
    }
};
