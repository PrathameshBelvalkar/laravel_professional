...
class UpdateWebsite extends RequestWrapper
{
    /**
    ...
    {
        return [
            "website_title" => ['string', 'min:3', 'max:255'],
            'custom_domian' => ['string'],
            'channels' => ['nullable', 'string', 'regex:/^\d+(,\d+)*$/'],
            'site_logo' => ['nullable', 'file', 'mimes:jpg,png,ico,svg,jpeg'],
            'site_favicon' => ['nullable', 'file', 'mimes:jpg,png,ico,svg,jpeg'],
            'header' => [Rule::in(['0', '1'])],
    ...
    public function messages()
    {
        return [
            ...
            'site_favicon.mimes' => 'The site_favicon extension should be only :values.',
