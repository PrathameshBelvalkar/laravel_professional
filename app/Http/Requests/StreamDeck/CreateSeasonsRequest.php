...
class CreateSeasonsRequest extends RequestWrapper
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'cover_image'=>'required|file|mimes:jpeg,jpg,png,gif,bmp,svg,webp,heic|max:15360',
    ...
    public function message(){
        return [
            'season_number.unique'=>'The season number already exists.',
        ];
    }
}
