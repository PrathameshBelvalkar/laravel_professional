...
class CreateChannelRequest extends RequestWrapper
{
    /**
    ...
    {
        return [
            "channel_name" => ['nullable', 'string', 'min:3', 'max:255', new UniqueChannelName],
    ...
    public function messages()
    {
        return [
            ...
            'channel_name.unique' => 'The channel name has already been taken.',
            'channel_type.required' => 'Channel type field is required',
            'channel_type.in' => 'Channel type should be either linear, fast or on demand.',
            'linear_channel_type.required' => 'Linear channel type field is required.',
            'linear_channel_type.in' => 'Linear type should be either scheduled or looped.',
            'schedule_duration.in' => 'Schedule duration should be either Daily or Weekly.',
            'start_time' => 'Start time format should be HH:MM.',
            'logo_position.in' => 'Logo position should either be right or left.',
            'logo_on_off.in' => 'Logo should either be on or off.',
