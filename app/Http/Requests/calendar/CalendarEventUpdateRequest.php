...
class CalendarEventUpdateRequest extends RequestWrapper
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'reminder' => ['json'],
            'visibiliy' => ['string', Rule::in(['1', '2', '3'])],
    ...
    public function messages()
    {
        return [
            ...
            'event_description.max' => 'Event description must not exceed :max characters.',
            ...
            'event_attachment.file' => 'Event attachment should be a file.',
            'event_attachment.mimes' => 'Event attachment extension should be only :mimes.',
            'event_attachment.max' => 'Event attachment size cannot exceed :max size.',
        ];
    }
