                            ...
                            <tr>
                                <td style="text-align: center; padding-bottom:25px">
                                    <a href="#"><img style="width: 200px" src="{{ $logoUrl }}"
                                            alt="logo"></a>
                                    <p style="font-size: 14px; color: #000; padding-top: 12px;display:none">
                                        {{ $title }}
                                    </p>
                                </td>
                            </tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 30px 30px 20px;text-align: center;">
                                    <h3>{{ $event_title }} - Reminder For {{ config('app.app_name') }} Event</h3>
                                    <p style="margin-bottom: 10px;">This email is to remind you that you have an event
                                        with {{ $owner_name }} on {{ $StartTime }} (GMT). </p>
                                    <p style="margin-bottom: 10px; color:red;">Please try to get early. We look forward
                                        to seeing you on {{ $StartTime }} (GMT).</p>
                                    <p style="margin-bottom: 10px;">You can simply connect using following link : </p>
                                    <a href="{{ $calender_url }}">{{ $calender_url }}</a>
