                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px 20px">
                                    ...
                                    <p class="text-center">{{ $sender_name }} is live right now!</p>
                                    <p class="text-center">Check out the live stream and see what's happening in real-time. Don't miss the action!</p>
                                    <p class="text-center">You can watch the live stream by scanning the QR code below or by clicking the link.</p>
                                    <p>Scan the QR code to join now:</p>
                                    <img src="{{ $qr_code_url }}" alt="Scan to Watch Live" style="width: 150px; height: 150px;">
                                    <br>
                                    ...
                                    <p style="margin-bottom: 15px;">We hope you enjoy the live stream! If you have any questions or need support, feel free to reach us at <a style="color: #4fcf4d; text-decoration:none;" href="mailto:{{ $supportMail }}">{{ $supportMail }}</a> anytime.</p>
                                </td>
