                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px 20px">
                                    ...
                                    <p class="text-center">You've just received exclusive access to {{$sender_name}} private TV network!</p>
                                    <p class="text-center">Check it out and explore a wide variety of shows, movies, and entertainment made just for you. Whether it's live streaming or on-demand, you're in for a treat.</p>
                                    <p class="text-center">Don't miss out on this opportunity to be part of something special!</p>
                                    <p>Get started by visiting {{ $projectName }} and enjoy your personalized TV experience.</p>
                                    <img src="{{$image_url}}">
                                    <br>
                                    <a href="{{ $link }}" target="_blank" style="cursor:pointer;">
                                        <button class="btn btn-primary"
                                            style="padding: 10px;margin:10px;background-color: #4fcf4d;border: none;color: white;width: 150px;border-radius: 5px;cursor:pointer;font-weight: 700;">
                                            Visit Now
                                        </button>
                                    </a>
                                    <p style="margin-bottom: 15px;">We hope you enjoy the experience! If you have any questions or need support, feel free to reach us at <a style="color: #4fcf4d; text-decoration:none;" href="mailto:{{ $supportMail }}">{{ $supportMail }}</a> anytime.</p>
