                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;"><b>Meeting Code:</b> {{ $meeting_code }}</p>
                                    @if ($meeting_start_time)
                                        <p style="margin-bottom: 10px;"><b>Meeting Start Time:</b>
                                            {{ $meeting_start_time }}
                                            <small>{{ strtoupper($meeting_time_zone) }}</small>
                                        </p>
                                    @endif
                                    @if ($meeting_end_time)
                                        <p style="margin-bottom: 10px;"><b>Meeting End Time:</b>
                                            {{ $meeting_end_time }}
                                            <small>{{ strtoupper($meeting_time_zone) }}</small>
                                        </p>
                                    @endif
                                    <a href="{{ $link }}" target="_blank"
                                        style="cursor:pointer!important;"><button class="btn btn-primary"
                                            style="padding: 10px;margin:10px;background-color: #4fcf4d;border: none;color: white;width: 150px;border-radius: 5px;font-weight: 700;">{{ $linkTitle }}</button></a>
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding:25px 20px 0;">
                                    ...
                                    <p style="padding-top: 15px; font-size: 12px;display:none">This email was sent to
                                        you as a
