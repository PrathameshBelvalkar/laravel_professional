                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">{{ $subMessage }}</p>
                                    <a href="{{ $verifyLink }}" target="_blank" style="cursor:pointer;"><button
                                            class="btn btn-primary"
                                            style="padding: 10px;margin:10px;background-color: #4fcf4d;border: none;color: white;width: 150px;border-radius: 5px;cursor:pointer;font-weight: 700;">{{ $linkTitle }}</button></a>
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding:25px 20px 0;">
                                    <p style="font-size: 13px;">&#169;{{ $projectName }} {{ date('Y') }}. All
                                        rights reserved.<br>
                                    </p>
