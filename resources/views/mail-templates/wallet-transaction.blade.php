                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px 20px">
                                    ...
                                    @endif
                                    <p style="margin-bottom: 10px;">{{ $sub_message }}</p>
                                    <a href="{{ $transaction_link }}" target="_blank"
                                        style="cursor:pointer;display:none;"><button class="btn btn-primary"
                                    ...
                                    <p style="margin-bottom: 15px;">Hope you'll enjoy the experience, we're here if
                                        you have any questions, drop us a line at <a
