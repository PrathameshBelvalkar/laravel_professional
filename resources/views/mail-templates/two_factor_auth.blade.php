                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">Your verification code is: <span style="color: #4fcf4d;"> {{ $otp }} </span> Please use this code to complete the two-factor authentication process.</p>
