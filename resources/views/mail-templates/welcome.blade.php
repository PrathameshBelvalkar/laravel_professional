                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px 20px">
                                    ...
                                    <p class="text-center">We're happy to have you with us.</p>
                                    <p class="text-center">Explore cloud storage with {{ config('app.app_name') }} for
                                        a reliable and
                                        secure, places for your personal data. Simple and scalable, Low latency,
                                        Optimized data transfer, secure and durable.</p>
                                    <p class="text-center">{{ config('app.app_name') }} is one platform for all your
                                        business needs.
                                    </p>
                                    <p>Verify your account to explore {{ $projectName }} if not done yet</p>

                                    <a href="{{ $link }}" target="_blank" style="cursor:pointer;"><button
                                            class="btn btn-primary"
                                            style="padding: 10px;margin:10px;background-color: #4fcf4d;border: none;color: white;width: 150px;border-radius: 5px;cursor:pointer;font-weight: 700;">Let's
